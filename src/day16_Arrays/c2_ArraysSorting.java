...
public class c2_ArraysSorting {
    ...
    public static void main(String[] args) {
        ...
        //sort : it will sort numbers from the smallest number to the biggest numbers.
        ...
        int max=numbers[0]; // I assume numbers index 0 is max number
        ...
        Arrays.sort(names); // it will sort names as alphabetic numbers
