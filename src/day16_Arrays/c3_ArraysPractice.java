...
public class c3_ArraysPractice {
    ...
    public static void main(String[] args) {
        ...
        //Create a program what will print numbers from biggest to smallest in given array.
...
//                        0          1          2         3         4           5         6
        ...
        int maxLengthIndex=0; // assume that names index 0 has the longest length;

        for (int i = 0; i < names.length ; i++) {

            System.out.println(""+ names[i]+ " has "+ names[i].length()+" length");
            //   i=0    0< 7             i++
            // i=1     1<7
